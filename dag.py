...
def DAG(model,image,ground_truth,adv_target,num_iterations=None,gamma = None ,no_background=True,background_class=0,device='cuda:0',verbose=False):
    '''
    ...
    for a in range(num_iterations):
        ...
        image_iteration.append(image[0].detach().cpu().numpy())
